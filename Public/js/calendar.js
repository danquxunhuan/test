define(function(require, exports){
		...
		jQ(document).on('click','#idCalendar td',function(){
			var title = jQ(this).data('title')
				...
				,boxData = '<h2>'+title+'</h2><p>活动介绍：'+memo+'</p><p>开始时间：'+starttime+'</p><p>结束时间：'+endtime+'</p><p>活动地点：'+place+'</p><p>主办单位：'+undertake+'</p><p>活动链接：<a href="'+link+'" target="_blank">点击这里</a></p><i class="i-jiao"></i>'
				;
	        if(title!=undefined){
