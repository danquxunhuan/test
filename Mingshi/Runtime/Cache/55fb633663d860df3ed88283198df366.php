       ...
       <div class="jbxx_right nob_jbxx_right fl">
            <div class="zyxx_box zyxx_box_fff">
                ...
                <ul class="yq_tab" id="news">
                    ...
                    <li class="yq_amo"><a href="__APP__/mystory/index/uid/<?php echo ($_GET['uid']); ?>" >我的故事</a></li>
			   ...
			   <!-------------我的故事---------------->
				...
				<?php if(is_array($mystory)): $i = 0; $__LIST__ = $mystory;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vom): $mod = ($i % 2 );++$i;?><dl class="fix pad0">
                        <dt class="ms_xiugai"><a href="javascript:void(0);"><img src="__PUBLIC__/images/xg.png" /></a></dt>
                        <dd>
                           <h3><span class="gushi1 fr"><!--a href="javascript:void(0);" id="<?php echo ($vom["id"]); ?>">修改</a-->
						   <a href="javascript:void(0);" class="delstory" id="<?php echo ($vom["id"]); ?>">删除</a>
						   </span><?php echo ($vom["title"]); ?></h3>
                           <div><?php echo ($vom["msg"]); ?></div>
                           <div class="zyxx_www">
						    <form>
						        <div class="gushi_inp"> <input type="text" name='title' placeholder="标题" value="<?php echo ($vom["title"]); ?>"></input></div>
                           		<!--zyxx_625 放小型编辑器-->
                                <!--div class="zyxx_625 bjqi fix">编辑器</div-->
								<textarea type="text/plain" class="content" style="width:570px;height:80px;"><?php echo ($vom["msg"]); ?></textarea>
                                <div class="hui_lan">
                                    <div class="zyxx_lin36 fl">有评论可删除不可修改</div>
                                    <div class="zyxx_cun mar_left116 fr">
									<a class="zyxx_pj_fb gbbox" href="javascript:;">关 闭</a>
									<a class="zyxx_pj_fb zyxx_lan_a story_edit" id="<?php echo ($vom["id"]); ?>" href="javascript:void(0);">确 定</a>
									</div>
                       	   		</div>
							</form>	
                           </div>
                ...
                <div class="jbxx_yk_list">
                   ...
                   <dl class="fix" style="border-bottom:none">
                        <dt class="ms_xiugai"><a href="javascript:void(0);"><img src="__PUBLIC__/images/zuanxie.png" /></a></dt>
                        <dd>
                           <h3>我的故事</h3>
                           <div>请开始撰写您的故事</div>
                           <div class="zyxx_www">
						    <form>
						        <div class="gushi_inp"> <input type="text" name="title" id="title" placeholder="标题" value=""></input></div>
                                <!--zyxx_625 放小型编辑器-->
                                <!--div class="zyxx_625 bjqi fix">编辑器</div-->
								<textarea  type="text/plain" id="content" style="width:570px;height:80px;"></textarea>
                                <div class="hui_lan">
                                    <div class="zyxx_lin36 fl">有评论可删除不可修改</div>
                                    <div class="zyxx_cun mar_left116 fr">
									<a class="zyxx_pj_fb gbbox" href="javascript:;">关 闭</a>
									<a class="zyxx_pj_fb zyxx_lan_a story" href="javascript:;">确 定</a>
									</div>
                       	   		</div>
							</form>	
                           </div>
