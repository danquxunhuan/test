    ...
    <ul class="ul1">
        ...
        <li>&nbsp;&nbsp;&nbsp;<a href="__APP__/Lesson" >课程列表</a></li>
                ...
                <div id="Right"  class="right">
                    <div class="tab1">
                        <div class="current">教学方案列表</div>
                    </div>
					 <div class="right_list"> 
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab">
<tr><th>方案ID</th><th>老师姓名</th><th>约课人姓名</th><th>约课人联系方式</th><th>设计时间</th><th>当前状态</th><th>操作</th></tr>
<!--约课信息-->
...
<?php else: ?>已结束<?php endif; ?></td>
        <td>[ <a href="__URL__/edit?id=<?php echo ($vo["id"]); ?>">编辑 </a> ] [ <a link="__URL__/del/id/<?php echo ($vo["id"]); ?>" href="javascript:void(0)" name="此教学方案" class="del">删除 </a> ]</td>
