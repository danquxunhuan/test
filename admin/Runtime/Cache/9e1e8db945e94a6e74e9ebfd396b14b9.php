...
<?php if(is_array($alist)): $i = 0; $__LIST__ = $alist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tree): $mod = ($i % 2 );++$i;?><tr pid="<?php echo ($tree["pid"]); ?>" cid="<?php echo ($tree["id"]); ?>">
<td align="left" class="tree" style="cursor: pointer;"><?php echo ($tree['fullname']); ?></td>
<td>[ <a href="__URL__/edit/id/<?php echo ($tree['id']); ?>">编辑</a> ][ <a link="__URL__/del/id/<?php echo ($tree['id']); ?>" href="javascript:void();" name="<?php echo ($tree['name']); ?>" class="del" onclick="delarea();" >删除</a> ]</td></tr><?php endforeach; endif; else: echo "" ;endif; ?>
<script type="text/javascript">
	$(function(){
		//删除
		$(".del").click(function(){
