...
<table>
<tr height="40"><td>父级地区：</td><td><select name="pid" class="inpu2">
<?php if(is_array($alist)): $i = 0; $__LIST__ = $alist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo['id']); ?>" <?php if($vo['id'] == $info['pid']): ?>selected="selected"<?php endif; ?>><?php echo ($vo['fullname']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
</select></td></tr>

<tr height="40"><td>地区名称：</td><td><input type="text" name="name" class="inpu2" value="<?php echo ($info["name"]); ?>" /></td></tr>
<tr height="40"><td><input type="submit" value="修 改" class="btn submit" /></td></tr>
